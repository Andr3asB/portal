<!-- Eingefrorene Kopie aus: accesslint/claude-marketplace (Plugin accesslint v0.10.3, accessibility-inspect/references/checkpoints.md), MIT-Lizenz.
     Uebernommen am 31.08.2026 nach vollstaendigem Review (journal.md).
     Aktualisierung nur bewusst: neue Fassung holen, KOMPLETT lesen, ersetzen. -->
